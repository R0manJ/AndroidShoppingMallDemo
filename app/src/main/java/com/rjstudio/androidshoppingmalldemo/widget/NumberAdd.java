...
// */
//public class NumberAdd extends LinearLayout implements View.OnClickListener {
//
//
...
//
//
//    public NumberAdd(Context context) {
//        this(context, null);
//    }
//
//    public NumberAdd(Context context, AttributeSet attrs) {
//        this(context, attrs, 0);
//    }
//
//    public NumberAdd(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                    R.styleable.NumberAdd, defStyleAttr, 0);
//
//
//            int val =  a.getInt(R.styleable.NumberAdd_value,0);
//            setValue(val);
//
//            int maxVal = a.getInt(R.styleable.NumberAdd_maxValue,0);
//            if(maxVal!=0)
//                setMaxValue(maxVal);
//
//            int minVal = a.getInt(R.styleable.NumberAdd_minValue,0);
//            setMinValue(minVal);
//
//            Drawable etBackground = a.getDrawable(R.styleable.NumberAdd_editBackground);
//            if(etBackground!=null)
//                setEditTextBackground(etBackground);
//
//
//            Drawable buttonAddBackground = a.getDrawable(R.styleable.NumberAdd_buttonAddBackgroud);
//            if(buttonAddBackground!=null)
//                setButtonAddBackgroud(buttonAddBackground);
//
//            Drawable buttonSubBackground = a.getDrawable(R.styleable.NumberAdd_buttonSubBackgroud);
